    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          Swal.fire("Error!", "Failed to delete the author.", "error");
        }
      }
    });
  };

  // Fungsi untuk memangkas biografi
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen">
        <p className="text-xl dark:text-gray-200">Loading authors...</p>
      </div>
    );
  }
      ...
      <section className="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
        <div className="mx-auto max-w-screen-xl px-4 lg:px-12">
          <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    authors.map((author) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          {author.photo ? (
                            <img
                              src={`http://127.0.0.1:8000/storage/author/${author.photo}`}
                              alt={author.nama}
                        ...
                        <td className="px-4 py-3">
                          {truncateBio(author.biografi, 100)}{" "}
                          {/* Pangkas biografi */}
                        </td>
                        <td className="px-4 py-3 flex items-center justify-end relative">
                          <button
                            id={`actions-dropdown-button-${author.id}`}
                          ...
                          {openDropdownId === author.id && (
                            ...
                            >
                              <ul
                                ...
                                aria-labelledby={`actions-dropdown-button-${author.id}`}
                              >
                                <li>
                                  <Link
            ...
            {/* Pagination placeholder - Anda bisa mengimplementasikan logika pagination di sini */}
            <nav
            ...
            >
              ...
              <ul className="inline-flex items-stretch -space-x-px">
                ...
                {/* Contoh pagination statis, Anda bisa mengimplementasikan dinamis */}
                <li>
                  <a
                    href="#"
