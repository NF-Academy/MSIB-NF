  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen">
        <p className="text-xl dark:text-gray-200">Loading genres...</p>
      </div>
    );
  }
                    ...
                    genres.map((genre) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          {truncateDescription(genre.description, 100)}
                        </td>
                        <td className="px-4 py-3 flex items-center justify-end relative">
                          <button
                            id={`actions-dropdown-button-${genre.id}`}
                          ...
                          {openDropdownId === genre.id && (
                            ...
                            >
                              <ul
                                ...
                                aria-labelledby={`actions-dropdown-button-${genre.id}`}
                              >
                                <li>
                                  <Link
