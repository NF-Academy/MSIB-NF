  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen">
        <p className="text-xl dark:text-gray-200">Loading books...</p>
      </div>
    );
  }
                    ...
                    books.map((book) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 flex items-center justify-end relative">
                          <button
                            id={`actions-dropdown-button-${book.id}`}
                          ...
                          {openDropdownId === book.id && (
                            ...
                            >
                              <ul
                                ...
                                aria-labelledby={`actions-dropdown-button-${book.id}`}
                              >
                                <li>
                                  <Link
